...
<body>
    <div class="form">
        <a href="menu.php" class="back_btn"><img src="../images/icons8-flèche-gauche-24.png"> Retour</a>
        ...
        <form action="db.php?action=modifier" method="POST">
            ...
            <label>Catégorie</label>
            <input type="text" name="categorie" value="<?= htmlspecialchars($plat['categorie']); ?>" required>
