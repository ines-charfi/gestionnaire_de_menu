                ...
                if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
                        ...
                        if (in_array($imageExtension, $validExtensions)) {
                                ...
                                if (move_uploaded_file($imageTmpName, $imageDestination)) {
                                        ...
                                        $query = "UPDATE menu SET description = :description, prix = :prix, image = :image, catégorie = :categorie WHERE id = :id";
...
<body>
        <div class="form">
                <a href="menus.php" class="back_btn"><img src="../images/back.jpg"> Retour</a>
                ...
                <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <a class="btn-liste-menu" href="menus.php">Liste de menu</a>
                </form>
        </div>
</body>
