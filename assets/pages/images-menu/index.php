...
<body>
    ...
    <header>
        <h1>Bienvenue sur le gestionnaire de menus!</h1> 
            ...
            <div class="container">
            <a href="ajouter_menus.php" class="Btn_add"> <img src="../images/ajouter.jpg"> Ajouter un menu</a>
            <a href="CRUD_plat.php" class="Btn_add"> <img src="../images/ajouter.jpg"> Ajouter un plat</a>
            <?php
