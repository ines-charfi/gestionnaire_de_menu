...
if (isset($_POST['btn_ajouter'])) {
    ...
    if (!empty($id) && !empty($description) && !empty($prix) && !empty($image) && !empty($catégorie)) {
        ...
        if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
            ...
            $deplacer_image = move_uploaded_file($tmp_nom, "images/" . $nouveau_nom_ing);
...
<body>
    ...
    <div class="container">
        ...
        <a href="plats.php" class="Btn_add"> <img src="./assets/images/ajouter.jpg"> Ajouter un plat</a>
        <?php
            ...
            if ($stmt->rowCount() == 0) {
                ...
                while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
                    ...
                    <tr>
                        ...
                        <td><a href="modifier_menu.php?id=<?= htmlspecialchars($row['id']) ?>"><img src="./assets/images/pen.jpg"
                                    alt="modifier"></a></td>
                        <td><a href="supprimer_menu.php?id=<?= htmlspecialchars($row['id']) ?>"><img src="./assets/images/track.jpg"
                                    alt="supprimer"></a></td>
                    </tr>
                    <?php
                }
